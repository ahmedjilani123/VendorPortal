		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Procurement",
									"targetURL": "#sapajvendorpro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapajvendorpro-display": {
								"semanticObject": "sapajvendorpro",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.aj.vendorpro",
									"url": sap.ui.require.toUrl("sap/aj/vendorpro")
								}
							}
						}
					}
